  ...
  render() {
    return (
      <ul className="filter-items">
        ...
        <DatePicker value={this.props.startDate} onChange={v => this.props.onStartDateChange(v)}/>
        <span className="value-to-value">到</span>
        <DatePicker value={this.props.endDate} onChange={v => this.props.onEndDateChange(v)}/>
      </ul>
    )
  }
}
